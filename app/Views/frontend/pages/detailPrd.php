        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-5">
                <div class="detail--img">
                    <img style="width: 100%;" src="<?= $GLOBALS["domainPage"] ?>/uploads/<?= $detailPrd['image'] ?>"
                        alt="">
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-7">
                <div class="detail__info">
                    ...
                    <form class="addToCart" action="<?= $GLOBALS["domainPage"] ?>/cart/addToCart" method="post">
                    ...
                    <div class="detail__desc">
                        <h3>MÔ TẢ NGẮN</h3>
                        <p class="detail__desc--text"><?= $detailPrd['description'] ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-5 col-lg-5">
                    ...
                    <div class="notAuth">
                        ...
                        <a class="notAuth--link" href="<?= $GLOBALS["domainPage"] ?>/account">Đăng nhập để mua sắm và
                            bình
                            luận</a>
                ...
                <div class="col-12 col-md-7 col-lg-7  lc">
                    ...
                    <div class="commentBox">
                        <img class="commentBox--img" src="<?= $GLOBALS["domainPage"] ?>/uploads/<?= $item['avatar'] ?>"
                            alt="">
                        ...
                        <div class="commentBox--right">
                            ...
                            <form class="form__update-cmt" action="<?= $GLOBALS["domainPage"] ?>/comment/updateCmt"
                                method="POST">
                    ...
                    <a href="<?= $GLOBALS["domainPage"] ?>/product/detail?prd&id=<?= $item['id'] ?>">
                        <div class="product__item">
                            <div class="product__img"><img
                                    src="<?= $GLOBALS["domainPage"] ?>/uploads/<?= $item['image'] ?>" alt="">
                            </div>
